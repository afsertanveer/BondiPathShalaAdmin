...
const McqSpecialExamDetails = () => {
  ...
  useEffect(() => {
    setIsLoading(true)
    axios
      .get('/api/course/getallcourseadmin')
      .then(({ data }) => {
  ...
  return (
    <div className=" bg-white  min-h-[800px]">
      <div className=" py-4 px-2 my-3 ">
        <div className="w-full  lg:w-2/3 px-4 py-4 mx-auto flex flex-row justify-between items-center">
              ...
              {detailedExam ? (
                detailedExam.map((data, index) => (
                  ...
                  >
                    ...
                    <td>{examInfo.name}</td>
                    <td>
                      {data.totalObtainedMarks ?? 0}/{examInfo.totalMarks}
                    </td>
                    <td>
                ...
                <tr>
                  <td colSpan={9}>
                    <p className="my-2 text-3xl text-center font-bold text-red">
                      No Data Found
                    </p>
                  </td>
                </tr>
...
export default McqSpecialExamDetails
