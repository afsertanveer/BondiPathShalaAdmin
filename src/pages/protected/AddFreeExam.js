      ...
      <div className="w-full lg:w-2/3 py-2  bg-white flex flex-col mx-auto  px-4  rounded-lg  shadow-lg ">
        ...
        <div className="px-4 lg:px-10">
          ...
          <div className="form-control">
            ...
            {
              selectedVariation==="1" && <div className="form-control grid grid-cols-1 lg:grid-cols-2 gap-y-2 gap-x-2">
              <div className="">
                <label htmlFor="" className="label">
                  Total Question
                </label>
            ...
            <div className="form-control grid grid-cols-1 lg:grid-cols-3 gap-x-2 gap-y-2">
              ...
              <div className="flex items-center justify-center mt-0 lg:mt-8 ">
                  <input
...
//     formdata.append("marksPerMcq",marksPerMcq)
//     formdata.append("status",status)
//     formdata.append("subjectId",freeSubjecteId)
