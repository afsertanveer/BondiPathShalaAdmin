...
const QuestionAdderSpecial = ({
  ...
  const handleOptionChange = (value,id)=>{
    const getOptions = mcqOptions;
    getOptions[id]= value;
    setMcqOptions(getOptions);
  }
  return (
    <div>
                      ...
                      <div key={id}>
                        <div>
                          ...
                          <input
                            ...
                            onBlur={e=>handleOptionChange(e.target.value,id)}
                            required
                          />
                        </div>
                      </div>
...
export default QuestionAdderSpecial
