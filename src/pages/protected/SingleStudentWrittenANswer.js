    ...
    <div>
      {
        ...
        //   <Fragment>
        //     {
        //       ansTracker[counter-1] === 0 && (
        //         <Fragment>
        //           <p className="text-red-500 font-bold text-center mt-5">
        //             No answer for question no {counter}
        //           </p>
        //           <form onSubmit={sendImage} className="mt-4 ">
        //             <input
        //               type="text"
        ...
        //             />
        //             <p className="ml-4 text-lg font-bold text-red">
        //               Marks out of {singleResult.marksPerQuestion[counter-1]}
        //             </p>
        //             <div className="flex ">
        //               <input
        //                 type="text"
        ...
        //                 autoComplete="off"
        //                 className="input input-bordered  border-black"
        //                 onChange={(e) => checkNumber(e.target.value, counter-1)}
        //                 required
        //               />
        //               <input
        //                 type="submit"
        ...
        //                   process.env.REACT_APP_API_HOST +
        //                   "/" +
        //                   singleResult.answerScript[counter-1][0],
        //                 name: "SampleImage",
        //               },
        //               menu: ["draw"],
        //               initMenu: "draw",
        ...
        //             ref={imageEditor}
        //           />
        //           <button className="btn my-4 justify-center" onClick={logImageContent}>Save Image</button>
