...
const ViewSingleScriptAdmin = () => {
  ...
  const sendImage = async (e) => {
    ...
    console.log(answer);
    await axios.post("/api/special/checkscriptsingleadmin", answer).then((data) => {
  ...
  const finalSave = async () => {
    ...
    await axios
      .post("/api/special/markscalculationadmin", marksCalculation)
      .then((data) => {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `/api/special/getwrittenstudentsinglebyexamadmin?examId=${params.examId}&studentId=${params.studentId}&subjectId=${params.subjectId}`
      )
      .then(({ data }) => {
        console.log(data);
...
export default ViewSingleScriptAdmin;
