...
const AddExam = () => {
  ...
  const handleAddExam = async (e) => {
    ...
    const exam = {
      ...
      startTime,endTime,duration,totalQuestionMcq,marksPerMcq,totalMarksMcq,status,
    ...
    formdata("exam",JSON.stringify(exam));
    await axios.post(`api/exam//createexam?exam=${JSON.stringify(exam)}`,formdata, {
      headers: {
  ...
  return (
    <div>
      <div className="w-full lg:w-2/3 py-10 mt-10 bg-white flex flex-col mx-auto  px-4 border border-white rounded-lg  shadow-lg ">
        ...
        <div className="px-4 lg:px-10">
          <form onSubmit={handleAddExam}>
            <div className="form-control">
              ...
              <input
                className="input input-bordered  border-black mb-2"
                type="text"
                name="exam"
                id="exam"
            ...
            <div className="form-control flex flex-col lg:flex-row justify-between">
              <div className="w-full lg:w-1/4">
                ...
                <select
                  name="type"
                  id="type"
                  className="input border-black input-bordered w-full my-5"
            ...
            <div className="form-control flex flex-col lg:flex-row justify-between  items-start lg:items-center">
              <div className="w-full lg:w-1/2 mr-0 lg:mr-4">
                ...
                <select
                  name="course"
                  id="course"
                  className="input w-full  border-black input-bordered my-3"
                  required
            ...
            <div className="form-control flex flex-col lg:flex-row justify-between items-start lg:items-center">
              <div className="w-full lg:w-1/2 mr-0 lg:mr-4">
                ...
                <input
                  type="datetime-local"
                  className="input input-bordered w-full  border-black my-3"
                  name="start_time"
                  id="start_time"
                  required
                />
            ...
            <div className="form-control">
              <div className="w-full">
                ...
                <input
                  type="mumber"
                  className="input w-full input-bordered border-black my-3"
                  name="duration"
                  id="duration"
                  min="1"
                  onInput={(e) =>
            ...
            <div className="form-control flex flex-col lg:flex-row justify-between items-start lg:items-center">
              <div className="w-full lg:w-1/4">
                ...
                <input
                  type="number"
                  className="input w-full input-bordered  border-black mt-3 lg:mt-1 mb-2"
              ...
              <div className="w-full lg:w-1/4">
                ...
                <input
                  type="number"
                  className="input w-full input-bordered  border-black mt-3 lg:mt-1 mb-3"
                  name="total_marks"
                  id="total_marks"
                  onInput={(e) =>
                    e.target.value < 0 ? (e.target.value = "") : e.target.value
            ...
            <div className="form-control flex flex-col lg:flex-row justify-between items-start lg:items-center">
              ...
              <div className="w-full lg:w-1/4">
                ...
                <select
                  ...
                  name="ssc"
                  id="ssc"
                  onChange={(e) => setIsSSC(e.target.value)}
                  required
                >
                  <option value={false} defaultChecked>
                    No
              ...
              <div className="w-full lg:w-1/4">
                ...
                <select
                  ...
                  name="hsc"
                  id="hsc"
                  onChange={(e) => setIsHSC(e.target.value)}
                  required
                >
                  <option value={false} defaultChecked>
                    No
            ...
            <div className="form-control">
              ...
              <input
                ...
                name="iLink"
                id="iLink"
                className="file-input w-full input-bordered  border-black mt-3 lg:mt-1 mb-2"
                required
              />
            </div>
            <div className="form-control mt-4">
              <input type="submit" value="Add Exam" className="btn w-[150px]" />
            </div>
          </form>
        </div>
      </div>
